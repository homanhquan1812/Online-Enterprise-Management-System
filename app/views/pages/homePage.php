    ...
    <header class="p-3 text-bg-dark">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div class="text-end">
                    <button onclick="document.location='http://localhost/Assignment/index.php?page=Login'" type="button" class="btn btn-outline-light me-2"><i class="fa-solid fa-right-to-bracket"> Login</i></button>
