...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Boss Page">
    ...
    <body>
        <div id="box">
            ...
            <h1 style="text-align: center; color: yellow;">Company Management</h1>
                <div class="form-container">
                    <h3 id="assigned_employee">Assigned Department Head: <span style="font-size: 30px; color: white;">Ho Manh Quan.</span></h3>
                    <h3 id="task_name">Task Name: <span style="font-size: 30px; color: white;">Survey about your Boss.</span></h3>
                    <h3 id="task_description">Task Description: <span style="font-size: 30px; color: white;">Fill in the survey then submit it to the Boss.</span></h3></h3>
                ...
                <form action="" method="POST">
                    <p style="color: yellow">1. Announce this department head to redo the task</p>
                    ...
                    <p style="color: orange; margin-left: 20px;">Comments for this department head:</p>
                    <br>
                    <div>
